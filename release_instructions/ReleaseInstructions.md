...
* Ensure the version   * Check that website has updated to align with the release docs. Verify that all new features and changes are reflected accurately on the website.pecified in `docs/conf.py` and `VERSION` align with the intended release version.
