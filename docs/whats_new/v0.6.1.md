...
v0.6.1 is a security fix / bug fix re- Fix timezone datetime edgecase (#2538) - @Innixma, @gradientsky
...
- Train and inference with different image data types (#2535) - @suzhoume.
