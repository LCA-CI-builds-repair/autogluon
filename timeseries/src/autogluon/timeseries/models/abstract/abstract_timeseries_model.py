...
from autoglu        """Return the evaluation scores for a given metric and dataset. The last
        `self.prediction_length` time steps of each time series in the input dataset
        ...
        metric: str
            String identifier of the evaluation metric to use, from one of
        ...
        num_samples: int
            ...
            forecasts are generated by forward sampling from the fitted model.ors import HpoExecutor, RayHpoExecutor
